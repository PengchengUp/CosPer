    ...
    for i in range(args.prev, args.times):
        ...
        if model_str == "mlr": # convex
            ...
            if args.dataset[:2] == "ag":
                args.model = fastText(hidden_dim=emb_dim, vocab_size=98635, num_classes=args.num_classes).to(args.device)
            elif args.dataset[:2] == "so":
                args.model = fastText(hidden_dim=emb_dim, vocab_size=399198, num_classes=args.num_classes).to(args.device)
...
if __name__ == "__main__":
    ...
    # general
    parser.add_argument('-mo', "--motivation", type=bool, default=False, 
    ...
    # parser.add_argument('-scale', "--scaling_update", type=int, default=0,
    #                     help="whether do model scaling")
    ...
    print("Number of malicious clients: {}".format(args.malicious_num))
    print("Number of free riders: {}".format(args.random_update))
