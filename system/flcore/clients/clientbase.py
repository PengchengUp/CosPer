...
from utils.data_utils import read_client_data, read_malicious_client_data
...
class Client(object):
    ...
    def __init__(self, args, id, train_samples, test_samples, **kwargs):
        ...
        # self.train_scaling = kwargs['train_scaling']
    ...
    def random_update(self, model):
        ...
        return model
    ##########
    # def scaling_update(self, model, scaling_factor=10):
    #     for param in model.parameters():
